...
import com.mhr.maziar.bakingapp.data.DummyContent.DummyItem;
...
public class MyRecipeRecyclerViewAdapter extends RecyclerView.Adapter<MyRecipeRecyclerViewAdapter.ViewHolder> {
    ...
    public MyRecipeRecyclerViewAdapter(List<DummyItem> items, RecipeFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mContentView = (TextView) view.findViewById(R.id.servings);
        }
